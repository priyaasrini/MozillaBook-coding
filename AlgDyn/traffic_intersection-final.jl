...
function traffic_light_1(video, object, frame)
    fill_color = "black"
    sethue(fill_color)
    setopacity(0.8)
    Javis.box(-100, 0, 100, 220, :fillpreserve)
end

function traffic_light_2(video, object, frame)
    fill_color = "black"
    sethue(fill_color)
    setopacity(0.8)
    Javis.box(100, 0, 100, 220, :fillpreserve)
...
Object(traffic_light_1)
Object(traffic_light_2)
...
render(video, pathname = "AlgDyn/Javis-gifs/traffic_intersection_final.gif", framerate = 1)